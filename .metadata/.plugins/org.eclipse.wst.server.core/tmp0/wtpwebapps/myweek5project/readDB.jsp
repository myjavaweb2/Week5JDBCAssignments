...
<header>
	...
	<p>Please <a hreflang="">click here</a> to see a list of some of the famous NBA
		players.</p>
	...
	<% DAO.readFromDB(); %>
		...
		<tr>
			...
			<td><%= readToJSP.getCurrentLastTeam() %></td>
			<td><%= readToJSP.getPosition() %></td>
			<td><%= readToJSP.getTotalPoints() %></td>
			<td><%= readToJSP.getChampionshipsWon() %></td>
			<td><%= readToJSP.getMvpWon() %></td>
		</tr>
		<%} %>
	</table>
